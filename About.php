...
<head>
    ...
    <style>
        ...
        .about h1 { color: #2c3e50; margin-bottom: 2rem; }
...
<body>
    ...
    <section class="about">
        <h1>About Us</h1>
        <p>We are a passionate team dedicated to helping you achieve financial freedom through smart tracking and insights.</p>
        <h2>Our Team</h2>
        <ul class="team-list">
            <li>Malisha watarake</li>
            <li>Pasindu gamagedara</li>
            <li>Rashmi anuththara</li>
            
            <!-- Add more group member names here as needed -->
        </ul>
